...
Start here when you need orientation instead of one specific deep document.
...
- it is not the only source truth
- use it to find the right stronger documents quickly
